...
import AnularNotaRemisionView from "./anularNotaRemision.js";
...
export default async function AnularNotaRemisionPage() {
    // Verificación de permisos
    await checkPermissionAndRedirect("Anular Nota de Remision");
