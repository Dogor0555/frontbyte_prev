          ...
          <div className="flex-1 overflow-y-auto p-4 md:p-6">
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-lg border border-gray-200 p-4 md:p-6 w-full max-w-full overflow-x-hidden">
              <h2 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <FaTicketAlt className="text-gray-600" /> Configuración de Formato de Tickets
              </h2>

              {/* Sección Dimensiones */}
              <div className="border-b border-gray-200 pb-6 mb-6">
                <h3 className="text-md font-semibold text-gray-800 mb-4 flex items-center gap-2">
                  <FaRuler className="text-gray-500" /> Dimensiones del Ticket
                </h3>
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        max="200"
                        required
                        className="w-full rounded border border-gray-300 pl-10 pr-3 py-2 text-gray-900 outline-none focus:ring-1 focus:ring-gray-500 focus:border-gray-500"
                      />
                    </div>
              ...
              <div className="border-b border-gray-200 pb-6 mb-6">
                <h3 className="text-md font-semibold text-gray-800 mb-4 flex items-center gap-2">
                  <FaQrcode className="text-gray-500" /> Configuración de Código QR
                </h3>
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="relative">
                      <select
                        ...
                        onChange={handleInputChange}
                        className="w-full rounded border border-gray-300 px-3 py-2 text-gray-900 outline-none focus:ring-1 focus:ring-gray-500 focus:border-gray-500 appearance-none"
                      >
              ...
              <div className="border-b border-gray-200 pb-6 mb-6">
                <h3 className="text-md font-semibold text-gray-800 mb-4 flex items-center gap-2">
                  <FaEye className="text-gray-500" /> Elementos Visibles en el Ticket
                </h3>
              ...
              <div className="border-b border-gray-200 pb-6 mb-6">
                <h3 className="text-md font-semibold text-gray-800 mb-4 flex items-center gap-2">
                  <FaTextWidth className="text-gray-500" /> Texto del Pie de Página
                </h3>
                ...
                <div className="min-w-0">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full rounded border border-gray-300 px-3 py-2 text-gray-900 outline-none focus:ring-1 focus:ring-gray-500 focus:border-gray-500"
                    />
                  </div>
              ...
              <div className="flex flex-col sm:flex-row justify-between gap-3 pt-4 border-t border-gray-200">
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  >
                    <FaUndo className="h-3 w-3" /> Restablecer Valores
                  </button>
                </div>
