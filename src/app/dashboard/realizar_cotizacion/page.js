import RealizarCotizacionView from "./RealizarCotizacionView";
...
export default async function RealizarCotizacionPage() {
  await checkPermissionAndRedirect("Realizar Cotización");
