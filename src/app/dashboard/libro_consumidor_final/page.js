...
export default async function LibroVentasConsumidoresPage() {
    // Verificación de permisos
    await checkPermissionAndRedirect("Libro de Ventas a Consumidor Final");
