...
export default function AnularLiquidacionView({ user, hasHaciendaToken, haciendaStatus }) {
  ...
  useEffect(() => {
    const fetchFacturas = async () => {
      try {
        ...
        addToast("Error al cargar las liquidaciones: " + error.message, "error");
        setFacturas([]);
        setFacturasInvalidadas([]);
      } finally {
        setLoading(false);
  ...
  const handleAnularFactura = async (facturaId, motivo) => {
    ...
    try {
      ...
      addToast("Liquidación invalidada exitosamente", "success");
      setShowModal(false);
      setMotivoAnulacion("");
    } catch (error) {
  ...
  const handleGeneratePDF = async (facturaId) => {
    ...
    try {
      ...
      let filename = `LIQ-${facturaId}.pdf`;
            ...
            <div className="max-w-6xl mx-auto">
              <div className="mb-8">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                  <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Invalidar Liquidaciones</h1>
                    <p className="text-gray-600">
                      {facturas.length} {facturas.length === 1 ? "liquidación invalidable" : "liquidaciones invalidables"} 
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                    <div className="relative w-full md:w-64">
                      ...
                      <input
                        type="text"
                        placeholder="Buscar liquidaciones invalidables..."
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-yellow-700">
                        <strong>Nota:</strong> Solo puedes invalidar liquidaciones que hayan sido transmitidas en las últimas 32 horas y que no estén ya invalidadas.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {facturasOrdenadas.length === 0 && (
                  <div className="text-center py-10">
                    ...
                    <h3 className="text-lg font-medium text-gray-700">
                      {facturas.length === 0 ? 'No hay liquidaciones invalidables' : 'No se encontraron coincidencias'}
                    </h3>
                    <p className="text-gray-500 mt-1">
                      {facturas.length === 0 
                        ? 'Todas las liquidaciones transmitidas en las últimas 32 horas aparecerán aquí' 
              ...
              <div className="border-t border-gray-200 pt-8">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                  <div>
                    <h2 className="text-xl md:text-2xl font-bold text-gray-800">Liquidaciones Invalidadas</h2>
                    <p className="text-gray-600">
                      {facturasInvalidadas.length} {facturasInvalidadas.length === 1 ? "liquidación invalidada" : "liquidaciones invalidadas"}
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                    <div className="relative w-full md:w-64">
                      ...
                      <input
                        type="text"
                        placeholder="Buscar liquidaciones invalidadas..."
                ...
                {facturasInvalidadasOrdenadas.length === 0 && (
                  <div className="text-center py-10">
                    ...
                    <h3 className="text-lg font-medium text-gray-700">
                      No hay liquidaciones invalidadas
                    </h3>
                    <p className="text-gray-500 mt-1">
                      Las liquidaciones que invalides aparecerán en esta sección
                    </p>
                  </div>
                )}
              </div>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
            <div className="p-6">
              ...
              <p className="text-sm text-gray-500 mb-4">
                ¿Estás seguro de que deseas invalidar la liquidación #{facturaSeleccionada?.numerofacturausuario}?
              ...
              <div className="flex justify-end space-x-3">
                ...
                >
                  {anulando ? "Invalidando..." : "Invalidar Liquidación"}
                </button>
              </div>
            </div>
          </div>
