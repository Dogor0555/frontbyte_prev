...
export default function FacturasExportacionView( { user, hasHaciendaToken, haciendaStatus, initialFacturas } ) {
  ...
  const load = useCallback(async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/exportacion?${params}`, {
        credentials: "include"
      });
  ...
  const handleAnularFactura = async (facturaId) => {
    ...
    try {
      ...
      if (!response.ok || !data.ok) {
        throw new Error(data.descripcionMsg || data.error || "Error al anular la factura de exportación");
      }
          ...
          <div className="p-4 md:p-6">
            <div className="max-w-6xl mx-auto">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                <div>
                  <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Mis Facturas de Exportación</h1>
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                  <div className="relative w-full md:w-64">
                    ...
                    <input
                      type="text"
                      placeholder="Buscar por código, cliente, número..."
                  ...
                  <div className="relative date-picker-container">
                    <button
                      ...
                      className={`flex items-center gap-2 px-3 py-2 border rounded-lg bg-white hover:bg-gray-50 focus:ring-2 focus:ring-orange-500 ${
                        (fechaInicio || fechaFin) ? 'border-orange-500 bg-orange-50' : ''
                      }`}
                    >
                      <FaCalendarCheck className={`text-sm ${(fechaInicio || fechaFin) ? 'text-orange-600' : 'text-gray-600'}`} />
                  ...
                  >
                    <div className="bg-orange-600 text-white p-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className={`text-xs px-2 py-1 rounded-full font-medium ${
                          factura.estado === 'TRANSMITIDO' ? 'bg-green-100 text-green-800' :
                          factura.estado === 'RE-TRANSMITIDO' ? 'bg-orange-500/30 text-orange-100' :
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex justify-between items-center mb-3 pb-2 border-b border-gray-100">
                        <div className="flex items-center text-gray-600">
                          <FaCalendarAlt className="mr-1 text-orange-500 text-xs" />
                      ...
                      <div className="mb-3">
                        <div className="flex items-center text-gray-700 mb-1">
                          <FaUser className="mr-1 text-orange-500 text-xs" />
                    ...
                    <div className="bg-gray-50 px-3 py-2 flex flex-wrap gap-1 justify-between border-t border-gray-100">
                      ...
                      <button
                        ...
                        className="flex items-center text-orange-600 hover:text-orange-800 px-2 py-1 rounded text-xs font-medium"
                        ...
                        pages.push(
                          <button
                            ...
                            className={`px-3 py-1 border-t border-b ${
                              1 === page ? 'bg-orange-500 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'
                            }`}
                          >
                            1
                          </button>
                      ...
                      for (let i = startPage; i <= endPage; i++) {
                        pages.push(
                          <button
                            ...
                            onClick={() => setPage(i)}
                            className={`px-3 py-1 border-t border-b ${
                              i === page ? 'bg-orange-500 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'
                            }`}
                          >
                            {i}
                          </button>
                      ...
                      if (endPage < meta.pages) {
                        ...
                        pages.push(
                          <button
                            ...
                            className={`px-3 py-1 border-t border-b ${
                              meta.pages === page ? 'bg-orange-500 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'
                            }`}
                          >
                            {meta.pages}
                          </button>
              ...
              {!loading && rows.length === 0 && (
                <div className="text-center py-10">
                  ...
                  <h3 className="text-lg font-medium text-gray-700">
                    {meta.total === 0 ? 'No hay facturas de exportación registradas' : 'No se encontraron coincidencias'}
                  </h3>
                  <p className="text-gray-500 mt-1">
                    {meta.total === 0 ? 'Comienza creando tu primera factura de exportación' : 'Intenta con otros términos de búsqueda o rango de fechas'}
                  </p>
                  {hayFiltros && (
                    <button
                      onClick={limpiarFiltros}
