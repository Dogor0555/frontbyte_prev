...
const ordenarFacturas = (facturas) => {
  ...
  const handleDownloadJSON = async (iddtefactura) => {
    try {
      ...
      let filename = `exportacion-${iddtefactura}.json`; // fallback
...
return (
  <div className="flex h-screen bg-orange-50/50 text-black overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                ...
                <select
                  ...
                  className="px-3 py-2 border rounded-lg focus:ring-2 bg-white focus:ring-orange-500 focus:border-orange-500 text-gray-700"
                >
                  <option value="numero">Nº Documento (desc)</option>
              ...
              {currentItems.map((factura) => (
                ...
                >
                  ...
                  <div className="bg-gray-50 px-3 py-2 flex flex-wrap gap-1 justify-between border-t border-gray-100">
                    {/* Botón de Detalles */}
                    <button
                      onClick={() => handleViewDetails(factura.iddtefactura, factura.tipo_dte)}
            ...
            {facturasOrdenadas.length === 0 && (
              <div className="text-center py-10">
                ...
                <p className="text-gray-500 mt-1">
                  {facturas.length === 0 ? 'Comienza creando tu primera factura de exportación' : 'Intenta con otros términos de búsqueda'}
                </p>
              </div>
            )}
          </div>
